...
const Navbar = () => {
  ...
  return (
    <nav className="bg-black w-full shadow-md px-4 sm:px-8 md:px-15  py-4 relative z-50 opacity-[0.98]">
      {/* Top Row */}
      <div className="flex items-center justify-between">
        <h2 className="text-gray-300 text-2xl tracking-widest sm:tracking-[12px] font-[100]">TANN TRIM</h2>
